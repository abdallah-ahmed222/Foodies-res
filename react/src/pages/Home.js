...
export default function Home()
{
    ...
    const homeData = {
        ...
        thirdText:"everyone",
        fourthText: "My veggie-packed take on a deli-style pasta salad! I swap spiralized summer squash for half the noodles and a creamy tahini dressing." ,
        btnText:"view our menus" ,
        visibe : true

    }
    const newItems = items.filter((item) => (item.id < 5))
    const show = true
        ...
        <>
            ...
            <Container className='side-dishes'>
                ...
                <div className='d-flex justify-content-center align-items-center gap-2 pt-5 pb-3'>
                    ...
                    <div><h2 className='text'>OUR  MENU</h2></div>
                    <div className='border-top border-dark sec-border'></div>
                </div>
                <div className='text-center mb-5'>
                    <h2 className='title'>OUR TOP ITEMS</h2>
                </div>
                <Link to="ourmenu" as={ Link } className='text-decoration-none position-absolute top-25 new-btn end-0 fw-bold text-uppercase'>view our menus</Link>
...
{
    return axios.get( "https://foodiesdata.onrender.com/maincards" )
}