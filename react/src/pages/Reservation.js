...
import { FaFacebookF, FaInstagram, FaMobileAlt, FaStore, FaTwitter, FaWhatsapp} from 'react-icons/fa'
        ...
        <Container>
            <div className='d-flex flex-column text-center text-lg-start flex-lg-row pt-5 align-items-center mb-5 justify-content-between gap-5'>
                   ...
                   <span>Cellphone : +45 453 3445</span>
                    ...
                    <ul className="footer-list  list-unstyled w-75 ">
                        <li className="reservation-contact d-flex justify-content-center w-75 m-auto gap-3 me-2 mt-2">
                            <Link  to="/" className='d-flex rounded-circle text-black d-block p-2 align-items-center justify-content-center'>
                            <FaWhatsapp />
                            </Link>
                            <Link  to="/" className='d-flex rounded-circle text-black d-block p-2 align-items-center justify-content-center'>
                                <FaFacebookF />
               ...
               <Form className='flex-grow-1 ms-5' onSubmit={handleSupmit}>
                    <Row className="mb-3">
                        <Form.Group as={Col} xl={6} lg={6} xs={12} md={12} sm={12} controlId="formGridName">
                            <Form.Label className='form-label'>Your Name</Form.Label>
                            <Form.Control type="text" required />
                        </Form.Group>
                        <Form.Group as={Col} xl={6} lg={6} xs={12} md={12} sm={12} controlId="formGridEmail">
                            <Form.Label className='form-label'>Your Email</Form.Label>
                            <Form.Control type="text" required/>
                        </Form.Group>
                    </Row>
                    <Row className="mb-3">
                        <Form.Group as={Col} xl={6} lg={6} xs={12} md={12} sm={12} controlId="formGridPhone">
                            <Form.Label className='form-label'>Phone Number</Form.Label>
                            <Form.Control type="number"  required/>
                        </Form.Group>
                        <Form.Group as={Col} xl={6} lg={6} xs={12} md={12} sm={12} controlId="formGridPassword">
                    ...
                    <Row className="mb-3">
                        <Form.Group as={Col} xl={6} lg={6} xs={12} md={12} sm={12}  controlId="formGridEmail">
                            <Form.Label className='form-label'> Number of Guests</Form.Label>
                            <Form.Select defaultValue="Choose..." required >
                                <option>—Please choose an option—</option>
                                <option>0-25</option>
                                <option>26-50</option>
                        ...
                        <Button variant='primary' type="submit" className='form-btn py-3 px-4' >
                            Submit
                        </Button>  
